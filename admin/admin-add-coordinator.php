...
if($stmt1 and $stmt2) {
	if($stmt1->bind_param("sss", $username, $password, $role) and $stmt2->bind_param("sssisddis", $username, $name, $email, $telephone, $address, $latitude, $longitude, $postalcode, $upload_filename)) {
