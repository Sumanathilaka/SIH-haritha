...
--
-- Host: localhost
-- Generation Time: Feb 23, 2019 at 09:00 AM
...
INSERT INTO `postdetails` (`username`, `post_id`, `picture`, `text`, `location`, `time`, `picture2`) VALUES
('deshank', 1, 'blog-2.jpg', 'I found an awesome place to travel. but don\'t forget to carry a plant with u. Plant it there. One day u will be happy.', 'NITC', '2019-02-21 17:30:00', 'blog-3.jpg'),
('venky', 2, 'img_bg_4.jpg', 'wow simply awesome place with green world\r\n#greenArmy\r\n#greenWorld', 'Calicut', '2019-02-22 05:10:29', 'null'),
('deshank', 3, 'null', 'Have you seen this? No visit my web Site\r\ndeshankoshala.freeoda.com', 'NITC', '2019-02-22 05:10:18', 'null'),
('deshank', 10, 'null', 'Hi guys iam deshan From NITC ', 'NITC', '2019-02-22 12:24:23', 'null'),
('deshank', 11, '123.jpg', 'welcome to green world lets rock the world', 'NITC', '2019-02-22 12:31:18', '1235.jpg');
...
--
ALTER TABLE `followtable`
  MODIFY `followid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
