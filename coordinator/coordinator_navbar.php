...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="coordinator_home.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i><?php echo $username; ?></a>
  <div class="w3-dropdown-hover w3-hide-small w3-right">
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="right:0;">
      ...
      <a href="coordinator_logout.php" class="w3-bar-item w3-button">Logout</a>
    </div>
  </div>
